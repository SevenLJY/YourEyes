 ...
 */
public class UsernameRegisterActivity extends Activity implements GestureDetector.OnGestureListener{
    EditText et_username;
    GestureDetector detector;
    VoiceUtil voiceUtil;

    String message = "注册。请输入用户名，右滑语音输入，左滑删除，上滑确认，下滑返回.强烈建议您在家人朋友的帮助下进行注册。";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        SpeechUtility.createUtility(UsernameRegisterActivity.this, SpeechConstant.APPID+"=58593564");
        setContentView(R.layout.activity_username_register);
        voiceUtil = new VoiceUtil(UsernameRegisterActivity.this);
    ...
    public void onLongPress(MotionEvent motionEvent) {
        ...
        if(!Check.uesrname_stringFilter(username)){
            ...
            Intent intent = new Intent(UsernameRegisterActivity.this, PasswordRegisterActivity.class);
